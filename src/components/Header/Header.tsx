...
const Header = () => {
  ...
  return (
    <div className={style.headerComponent}>
      ...
      <li className={style.headerComponent_role_log_out}><button type="button" onClick={()=>navigate("/")} className={style.headerComponent_role_log_out_btn}><CiLogout/></button></li>
        <li className={classNames(style.headerComponent_role_item,style.headerComponent_role_item_last)}>
          ...
          {isModal?<div className={style.headerComponent_role_item_modal}>
            <button onClick={()=>{dispatch(changeRol(true));setIsModal(false);navigate("/admin")}} className={style.headerComponent_role_item_modal_btn}><MdAdminPanelSettings/> Admin</button>
